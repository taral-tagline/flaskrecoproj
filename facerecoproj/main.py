...
app = Flask(__name__)
camera = cv2.VideoCapture("/Users/tagline/Desktop/project/flask_img_reco/facerecoproj/taral/face_video.mp4")

my_image = face_recognition.load_image_file("/Users/tagline/Desktop/project/flask_img_reco/facerecoproj/taral/taral.jpeg")
